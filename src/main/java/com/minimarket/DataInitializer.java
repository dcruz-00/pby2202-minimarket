...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (categoriaRepository.count() > 0)
            return; // evita duplicados al reiniciar
        ...
        // Abarrotes
        Producto arroz = crearProducto("Arroz Grado 1 (1 kg)", 990.0, 80, abarrotes); // ← se usa abajo
        ...
        // Bebidas
        Producto cocacola = crearProducto("Coca-Cola (1.5 L)", 1290.0, 100, bebidas); // ← se usa abajo
        ...
        Producto leche = crearProducto("Leche entera (1 L)", 990.0, 110, lacteos); // ← se usa abajo
        ...
        Producto detergente = crearProducto("Detergente en polvo (1 kg)", 2190.0, 55, limpieza); // ← se usa abajo
        crearProducto("Cloro líquido (1 L)", 890.0, 70, limpieza);
        crearProducto("Esponja de cocina (x2)", 490.0, 90, limpieza);

        // Cuidado Personal
        Producto shampoo = crearProducto("Shampoo (400 ml)", 3290.0, 40, cuidado); // ← se usa abajo
